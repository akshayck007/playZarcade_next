  ...
  return (
    <section className="space-y-8">
      ...
      <div className="relative group/featured">
        ...
        <button 
          onClick={() => scroll('left')}
          className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 glass rounded-full flex items-center justify-center text-white/50 hover:text-neon-cyan hover:border-neon-cyan/50 transition-all opacity-100 md:opacity-0 md:group-hover/featured:opacity-100 z-20"
        ...
        <button 
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 glass rounded-full flex items-center justify-center text-white/50 hover:text-neon-cyan hover:border-neon-cyan/50 transition-all opacity-100 md:opacity-0 md:group-hover/featured:opacity-100 z-20"
