...
import { Save, ArrowLeft, Image as ImageIcon, Link as LinkIcon, Type, FileText, Layout, Star } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            <h1 className="text-4xl font-black uppercase tracking-tighter">Add New Game</h1>
            <p className="text-white/40 text-sm font-bold uppercase tracking-widest">Register a new title to the platform</p>
          </div>
        </div>
        <button 
              ...
              {!formData.isRetro ? (
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full glass p-4 rounded-xl text-sm font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                  />
                  <p className="text-[9px] text-white/20 font-mono uppercase">Leave empty to create a &quot;Shadow Page&quot; for SEO mining</p>
                </div>
              ) : (
        ...
        <aside className="space-y-8">
          ...
          <div className="glass p-8 rounded-3xl space-y-6 border border-white/5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-white/40">Initial Plays</label>
                <input 
                  type="number" 
